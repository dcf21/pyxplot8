...
\vspace{3mm}
{\footnotesize
\noindent{\tt pyxplot>~print~"\%d"~~\%(pi)~\#~Print~the~integer~part~of~pi}\newline
\noindent{\tt 3}\newline
\noindent{\tt pyxplot>~print~"\%.5f"\%(pi)~\#~Print~pi~in~non-scientific~format,~to~5~d.p.}\newline
\noindent{\tt 3.14159}\newline
\noindent{\tt pyxplot>~print~"\%.5e"\%(pi)~\#~Print~pi~in~scientific~format,~to~5~d.p.}\newline
\noindent{\tt 3.14159e+00}\newline
\noindent{\tt pyxplot>~print~"\%s"~~\%(pi)~\#~Print~pi~as~normal}\newline
