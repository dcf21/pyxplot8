...
In this example, we use of function splicing to calculate the Fibonacci numbers
in an iterative and highly inefficient way, using the knowledge that the zeroth
and first Fibonacci numbers are both one, and that all subsequent numbers are
the sums of their two immediate predecessors:
\nlscf
\noindent {\tt fib(x) = 1}\newline
