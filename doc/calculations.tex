...
\noindent {\tt pyxplot> {\bf print Bvmax(5800*unit(K))}}\newline
\noindent {\tt 340.9781 THz}
}
...
time\_julianday()}\indfun{time\_\-julianday({\it year},\-{\it month},\-{\it
...
\vspace{3mm}
\noindent{\tt pyxplot> {\bf print time\_julianday(2000,1,1,0,0,0.0)}}\newline
\noindent{\tt 2451544.5}
\vspace{3mm}
...
dates, since they days never occured in the British calendar. This behaviour
...
\noindent {\tt pyxplot> {\bf print time\_diff\_string(x,y,"\$\%Y\^{}$\backslash$mathrm\{y\}\%d\^{}$\backslash$mathrm\{d\}\$")}}\newline
