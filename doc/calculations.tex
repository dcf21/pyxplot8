...
\example{ex:funcsplice}{An example of the use of function splicing to define a function which does not have an analytic form}{
...
\begin{center}
\includegraphics{examples/eps/ex_funcsplice.eps}
\end{center}
}
