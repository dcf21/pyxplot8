...
CRange_Log = False
CRange_Max = 0
CRange_Max_Auto = True
CRange_Min = 0
CRange_Min_Auto = True
DataStyle = Points
Display = On
DPI = 300
FontSize = 1
...
{\tt Contour} & {\bf Possible values:} Any integer.
               ...
               \\
{\tt CRange\_Log} & {\bf Possible values:} {\tt True}, {\tt False}.

               {\bf Analogous set command:} \indcmdts{set logscale c}

               Sets whether colour maps are drawn with logarithmic or linear colour scales. Also sets whether contours demark linear or logarithmic intervals on contour maps.\indps{contourmap}\indps{colourmap}
               \\
{\tt CRange\_Max} & {\bf Possible values:} Any floating-point number.

               {\bf Analogous set command:} \indcmdts{set crange}

               Sets upper limit of the range of values demarked by differing colours on colour maps, and by contours on contour maps.
               \\
{\tt CRange\_Max\_Auto} & {\bf Possible values:} {\tt True}, {\tt False}.
