...
text, and Section~\ref{missing_features} lists some of the most significant
areas where the two interfaces differ.
...
Figure~\ref{ex:axislab}.  Note that the labels and title, and indeed all text
