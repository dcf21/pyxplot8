...
\noindent The output of this simple example can be seen in
Figure~\ref{fig:ex_intro_sine}. The function $\sin(x)$ is one of a large number
of standard mathematical functions, as well as some more specialised functions,
which are built into PyXPlot. We will meet more of these functions in due
course, but a complete list can be found in Appendix~\ref{ch:function_list}.

\begin{figure}
\centerline{\includegraphics[width=\textwidth]{examples/eps/ex_intro_sine.eps}}
\caption{A first plot of the trigonometric function $\sin(x)$.}
\label{fig:ex_intro_sine}
\end{figure}
...
\noindent The output of this latter example is shown in
Figure~\ref{fig:ex_intro_func}.

\begin{figure}
\centerline{\includegraphics[width=\textwidth]{examples/eps/ex_intro_func.eps}}
\caption{A plot of a user-defined cubic function $f(x)$.}
\label{fig:ex_intro_func}
\end{figure}
...
\example{ex:axislab}{A plot of the trajectories of rockets fired with different initial velocities}{
A plot of the trajectories of rockets fired with different initial velocities.  The key demonstrates the use of \LaTeX\ to render mathematical symbols attractively.\\
\begin{center}
