...
\begin{verbatim}
set viewer ( gv | ggv | evince | okular )
\end{verbatim}
...
terminals.  The available options are {\tt gv}, {\tt ggv}, {\tt evince} and
{\tt okular}, though the availability of each of these options is dependent
upon the relevant viewer having been installed on your system. The use of {\tt
gv} is strongly recommended on grounds of stability.
