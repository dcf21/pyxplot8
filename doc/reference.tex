...
The setting {\tt grid} controls whether a grid is placed behind a plot or not.
Issuing the command
...
The setting {\tt gridmajcolour} changes the colour that is used to plot the
...
The setting {\tt gridmincolour} changes the colour that is used to plot the
...
The setting {\tt pointlinewidth} changes the width of the lines that are used to
...
The setting {\tt xrange} controls the range of values along the {\tt x}-axes of
...
ticking options. The \indcmdt{set noxtics} is used to stipulate that no
