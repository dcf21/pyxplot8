...
\section{edit REMOVE ME}\indcmd{edit}
...
\section{image UPDATE ME}\indcmd{image}

This is no longer the jpeg command.
...
\subsection{dpi REMOVE ME}\indcmd{set dpi}

MOVE THIS TO THE SET TERMINAL SECTION
...
\subsection{style MOVE ME}\indcmd{set style}
...
\subsection{nostyle MOVE ME}\indcmd{set nostyle}
