...
been changed. A common use of the \indcmdt{refresh} is to produce multiple
...
modifier in the {\tt plot} command, except that the label string may be
prefixed by a keyword to specify how the pie wedge labels should be positioned.
...
format} modifier determines the final text which is associated with each wedge.
