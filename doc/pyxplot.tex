...
\usepackage{amssymb,amsmath,bbding,url,lscape,longtable,multicol,nicefrac,fancyvrb,makeidx,supertabular,upgreek,wasysym}
\makeindex
\input{definitions}
...
\listoffigures
\listof{boxout}{List of Examples}
