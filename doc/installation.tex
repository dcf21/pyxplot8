...
\vspace{2mm}
\noindent {\tt fftw3-dev}, {\tt gcc}, {\tt gs}, {\tt gv}, {\tt imagemagick}, {\tt libc6-dev}, {\tt libcfitsio3-dev},\newline
\noindent {\tt libgsl0-dev}, {\tt libkpathsea-dev}, {\tt libpng12-dev}, {\tt libreadline5-dev},\newline
\noindent {\tt libxml2-dev}, {\tt make}, {\tt texlive-latex-extra}, {\tt texlive-latex-recommended},\newline
\noindent {\tt texlive-fonts-recommended}, {\tt texlive-fonts-extra}, {\tt wget}, {\tt zlib1g-dev}.
\vspace{2mm}
