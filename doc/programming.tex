...
it to the terminal. Insert details about what the Mandelbrot Set is. The script
is as follows:\\
...
\noindent {\tt \phantom{xxxx}cd~=~Re((StepsMax/2-iter)**3/(StepsMax/2)**3+1)/2*256 }\newline
\noindent {\tt \phantom{xxxx}rect~from~xn,yn~to~xn+0.21,yn+0.21~with~col~null~$\backslash$ }\newline
