...
it contains, after all, only three colours in its strict definition -- we vary
the brightness of each point depending upon how many iterations are required
before the series ventures within a distance of $|z_n-r_i|<10^{-2}$ of any of
the roots $r_i$.
\nlscf
