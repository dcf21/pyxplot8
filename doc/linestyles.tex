...
\begin{table}
\begin{center}
\includegraphics{examples/eps/ex_linestyles2.eps}
\end{center}
...
\begin{table}
\begin{center}
\includegraphics{examples/eps/ex_linestyles.eps}
\end{center}
...
\begin{table}
\begin{center}
\includegraphics[width=\textwidth]{examples/eps/ex_linestyles3.eps}
\end{center}
