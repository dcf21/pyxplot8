...
\noindent{\tt \phantom{xxxxx}select (\$4/\$3<0.05) with dots ps 3}
\nlscf
...
Note that PyXPlot intelligently changes the positions where it places the ticks
along the axis to reflect significant points in the chosen labelling system.
