...
Various modifiers may be used to alter the exact appearance of the output
...
\end{itemize}
The plot style \indpst{errorbars} is an alias for \indpst{yerrorbars}.
...
The data used in this figure was produced using the following python script:
\nlscf
