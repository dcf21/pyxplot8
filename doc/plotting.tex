%ctal\_mandelbrot($z$,$m$)} PLOTTING.TEX
%
...
In addition to these four options, \indcot{axis<n>} specifies that the
...
\section{Colour Maps and Contour Plots}
...
complicated structure out of simple algorithms, and may be evaluated in PyXPlot
using the {\tt fractal\_\-mandel\-brot()} function\indfun{fractal\_mandelbrot($z$,$m$)}.
\nlnp
