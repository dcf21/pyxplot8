...
In the following example, a colour map of a quadrapole is produced using four
input datapoints:
...
The \indcmdt{set c1range} command specifies how the values of $c_1$ are
...
\end{verbatim}
If data is supplied from a \datafile, then it is first resampled onto a regular
