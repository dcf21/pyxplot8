...
char *SW_CALENDAR_STR[] = {"Gregorian"          , "Julian"          , "British"          , "French"          , "Catholic"          , "Russian"          , "Greek"          , "Hebrew"          , "Islamic"          };
