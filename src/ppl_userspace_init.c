...
void ppl_UserSpaceInit()
 {
  ...
  FunctionDescriptor fd_ast_moonphase     = { PPL_USERSPACE_SYSTEM , 0 , 1 , (void *)&dcfast_moonphase    , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{ast\\_moonphase}@<@1@>", "ast_moonphase(JD) returns the phase on the Moon at Julian Day number JD"};
  FunctionDescriptor fd_ast_sidereal_time = { PPL_USERSPACE_SYSTEM , 0 , 1 , (void *)&dcfast_sidereal_time, NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{ast\\_sidereal\\_time}@<@1@>", "ast_sidereal_time(JD) returns the sidereal time at Greenwich at Julian Day number JD"};
  ...
  FunctionDescriptor fd_chisqPDF      = { PPL_USERSPACE_SYSTEM , 0 , 2 , (void *)&dcfmath_chisqPDF    , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{\\chi^2 PDF}@<@1,@2@>", "chisqPDF(x,nu) returns the probability density at x in a chi-squared distribution with nu degrees of freedom"};
  FunctionDescriptor fd_chisqCDF      = { PPL_USERSPACE_SYSTEM , 0 , 2 , (void *)&dcfmath_chisqCDF    , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{\\chi^2 CDF}@<@1,@2@>", "chisqCDF(x,nu) returns the cumulative probability density at x in a chi-squared distribution with nu degrees of freedom"};
  FunctionDescriptor fd_chisqCDFi     = { PPL_USERSPACE_SYSTEM , 0 , 2 , (void *)&dcfmath_chisqCDFi   , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{\\chi^2 CDFi}@<@1,@2@>", "chisqCDFi(P,nu) returns the point x at which the cumulative probability density in a chi-squared distribution with nu degrees of freedom is P"};
  ...
  FunctionDescriptor fd_random        = { PPL_USERSPACE_SYSTEM , 0 , 0 , (void *)&dcfmath_frandom     , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{random}@<@>", "random(x) returns a random number between 0 and 1"};
  ...
  FunctionDescriptor fd_randomcs      = { PPL_USERSPACE_SYSTEM , 0 , 1 , (void *)&dcfmath_frandomcs   , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{random\\_\\chi^2}@<@1@>", "random_chisq(nu) returns a random sample from a chi-squared distribution with nu degrees of freedom"};
  ...
  FunctionDescriptor fd_randomt       = { PPL_USERSPACE_SYSTEM , 0 , 1 , (void *)&dcfmath_frandomt    , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{random\\_tdist}@<@1@>", "random_tdist(nu) returns a random sample from a t-distribution with nu degrees of freedom"};
  ...
  FunctionDescriptor fd_tdistPDF      = { PPL_USERSPACE_SYSTEM , 0 , 2 , (void *)&dcfmath_tdistPDF    , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{tdistPDF}@<@1,@2@>", "tdistPDF(x,nu) returns the probability density at x in a t-distribution with nu degrees of freedom"};
  FunctionDescriptor fd_tdistCDF      = { PPL_USERSPACE_SYSTEM , 0 , 2 , (void *)&dcfmath_tdistCDF    , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{tdistCDF}@<@1,@2@>", "tdistCDF(x,nu) returns the cumulative probability density at x in a t-distribution with nu degrees of freedom"};
  FunctionDescriptor fd_tdistCDFi     = { PPL_USERSPACE_SYSTEM , 0 , 2 , (void *)&dcfmath_tdistCDFi   , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{tdistCDFi}@<@1,@2@>", "tdistCDFi(P,nu) returns the point x at which the cumulative probability density in a t-distribution with nu degrees of freedom is P"};
  ...
  FunctionDescriptor fd_time_julianday= { PPL_USERSPACE_SYSTEM , 0 , 6 , (void *)&dcftime_julianday   , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{time\\_julianday}@<@1,@2,@3,@4,@5,@6@>", "time_julianday(year,month,day,hour,min,sec) returns the Julian Day number corresponding to the calendar date supplied"};
  FunctionDescriptor fd_time_now      = { PPL_USERSPACE_SYSTEM , 0 , 0 , (void *)&dcftime_now         , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{time\\_now}@<@>", "time_now() returns the present Julian Day number"};
  FunctionDescriptor fd_time_year     = { PPL_USERSPACE_SYSTEM , 0 , 1 , (void *)&dcftime_year        , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{time\\_year}@<@1@>", "time_year(JD) returns the calendar year corresponding to the Julian Day number JD"};
  FunctionDescriptor fd_time_monthnum = { PPL_USERSPACE_SYSTEM , 0 , 1 , (void *)&dcftime_monthnum    , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{time\\_monthnum}@<@1@>", "time_monthnum(JD) returns the number (1-12) of the calendar month corresponding to the Julian Day number JD"};
  FunctionDescriptor fd_time_monthname= { PPL_USERSPACE_STRFUNC, 0 , 2 , (void *)&dcftime_monthname   , NULL, NULL, NULL, NULL, NULL, NULL, "\\mathrm{time\\_monthname}@<@1,@2@>", "time_monthname(JD,length) returns the name, truncated to length characters, of the calendar month corresponding to the Julian Day number JD"};
  ...
  DictAppendPtrCpy  (_ppl_UserSpace_Funcs, "random_tdist"   , (void *)&fd_randomt     , sizeof(FunctionDescriptor), DATATYPE_VOID);
  ...
  DictAppendPtrCpy  (_ppl_UserSpace_Funcs, "tdistPDF"       , (void *)&fd_tdistPDF    , sizeof(FunctionDescriptor), DATATYPE_VOID);
  DictAppendPtrCpy  (_ppl_UserSpace_Funcs, "tdistCDF"       , (void *)&fd_tdistCDF    , sizeof(FunctionDescriptor), DATATYPE_VOID);
  DictAppendPtrCpy  (_ppl_UserSpace_Funcs, "tdistCDFi"      , (void *)&fd_tdistCDFi   , sizeof(FunctionDescriptor), DATATYPE_VOID);
  DictAppendPtrCpy  (_ppl_UserSpace_Funcs, "texify"         , (void *)&fd_texify      , sizeof(FunctionDescriptor), DATATYPE_VOID);
  DictAppendPtrCpy  (_ppl_UserSpace_Funcs, "time_julianday" , (void *)&fd_time_julianday , sizeof(FunctionDescriptor), DATATYPE_VOID);
