    ...
    if (state == 1) // [settings] section
     {
      ...
      if      (strcmp(setkey, "ASPECT"       )==0)
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))&&(fl>=1e-6)&&(fl<=1e4)))
                                                                                               { settings_graph_default.aspect        = fl;
                                                                                                 settings_graph_default.AutoAspect    = SW_ONOFF_OFF;
                                                                                               }
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))               settings_graph_default.bar           = fl;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))             { settings_term_default.BinOrigin.real = fl;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))             { settings_term_default.BinWidth.real  = fl;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))             { settings_graph_default.BoxFrom.real  = fl;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))             { settings_graph_default.BoxWidth.real = fl;
        ...
        if ((i=FetchSettingByName(setvalue,SW_CALENDAR_INT, SW_CALENDAR_STR ))>0)                settings_term_default.CalendarIn = i;
...
#define DO_CRANGE(c,X) \
      ...
      DO_CRANGE(0,"1")  DO_CRANGE(1,"2")  DO_CRANGE(2,"3")  DO_CRANGE(3,"4")
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))&&(fl>2)))       settings_term_default .dpi           = fl;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))               settings_graph_default.FontSize      = fl;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl)) && (i==strlen(setvalue)) && (fl>=0) && (fl<=MAX_AXES)))
         {
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))               settings_graph_default.KeyColumns    = max((int)fl, 0);
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))               settings_graph_default.KeyXOff.real  = fl/100;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))               settings_graph_default.KeyYOff.real  = fl/100;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))               settings_term_default .SignificantFigures = min(max((int)fl, 1), 30);
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))               settings_graph_default.OriginX.real  = fl/100;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))               settings_graph_default.OriginY.real  = fl/100;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))             { settings_term_default .PaperHeight.real  = fl/1000;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))             { settings_term_default .PaperWidth.real  = fl/1000;
                                                                              PaperHeight = settings_term_default.PaperHeight.real * 1000;
                                                                              PaperWidth  = settings_term_default.PaperWidth .real * 1000;
                                                                              ppl_GetPaperName(settings_term_default.PaperName, &PaperHeight, &PaperWidth);
                                                                            }
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))               settings_graph_default.PointLineWidth= fl;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))               settings_graph_default.PointSize     = fl;
...
//        else {sprintf(temp_err_string, "Error in line %d of configuration file %s: Illegal value for setting Projection."   , linecounter, ConfigFname); ppl_warning(ERR_PREFORMED, temp_err_string); continue; }
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))               settings_graph_default.TitleXOff.real  = fl/100;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))               settings_graph_default.TitleYOff.real  = fl/100;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))               settings_graph_default.XYview.real     = fl/180*M_PI;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue))))               settings_graph_default.YZview.real     = fl/180*M_PI;
...
#define GET_UNITNAME(output, last, type, sep, LaTeX) \
    ...
    else if (state == 10) // [styling] section
     {
      ...
      if      (strcmp(setkey, "BASELINE_LINEWIDTH"  )==0)
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue)))) EPS_DEFAULT_LINEWIDTH = fl * EPS_BASE_DEFAULT_LINEWIDTH;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue)))) EPS_DEFAULT_PS        = fl * EPS_BASE_DEFAULT_PS;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue)))) EPS_ARROW_ANGLE       = fl * M_PI / 180;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue)))) EPS_ARROW_HEADSIZE    = fl * EPS_BASE_ARROW_HEADSIZE;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue)))) EPS_ARROW_CONSTRICT   = fl;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue)))) EPS_AXES_SEPARATION   = fl * EPS_BASE_AXES_SEPARATION;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue)))) EPS_AXES_TEXTGAP      = fl * EPS_BASE_AXES_TEXTGAP;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue)))) EPS_AXES_LINEWIDTH    = fl * EPS_BASE_AXES_LINEWIDTH;
        ...
        if  (fl=GetFloat(setvalue, &i), ((gsl_finite(fl))&&(i==strlen(setvalue)))) EPS_GRID_MINLINEWIDTH    = fl * EPS_BASE_GRID_MINLINEWIDTH;
