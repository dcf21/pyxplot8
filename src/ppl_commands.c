...
set@2:directive                      calendar@1:set_option = < gregorian@1:calendar:Gregorian | julian@1:calendar:Julian | british@1:calendar:British | french@1:calendar:French | catholic@1:calendar:Catholic | russian@1:calendar:Russian | greek@5:calendar:Greek >\n\
...
set@2:directive { item@1 %d:editno } fontsize@1:set_option = %f:fontsize\n\
set@2:directive { item@1 %d:editno } fountsize@1:set_option:fontsize = %f:fontsize\n\
...
set@2:directive { item@1 %d:editno } numerics@2:set_option = ( < sigfig@3 | sf@2 > %d:number_significant_figures ~ errors@2 < explicit@1:errortype:On | nan@1:errortype:Off | quiet@1:errortype:Off | nonan@3:errortype:On | noquiet@3:errortype:On | noexplicit@3:errortype:Off > ~ < complex@1:complex:On | real@1:complex:Off | nocomplex@3:complex:Off | noreal@3:complex:On > ~ < typeable@1:typeable:On | natural@2:typeable:Off | notypeable@3:typeable:Off | nonatural@3:typeable:On > )\n\
...
set@2:directive { item@1 %d:editno } preamble@2:set_option = < %q:preamble | %Q:preamble | %r:preamble > \n\
...
set@2:directive { item@1 %d:editno } unit@1:set_option = ( display@1 ( < abbreviated@1:abbrev:On | noabbreviated@3:abbrev:Off | full@1:abbrev:Off | nofull@3:abbrev:On > ~ < prefix@1:prefix:On | noprefix@3:prefix:Off > ) ~ scheme@1 < si@2:scheme:SI | cgs@1:scheme:CGS | ancient@1:scheme:ANCIENT | imperial@1:scheme:IMPERIAL | usimperial@1:scheme:US | planck@1:scheme:PLANCK | natural@1:scheme:PLANCK > ~ [ of@1 %s:quantity %s:unit ]:prefered_units, )\n\
...
< spline@3:directive | interpolate@4 < linear@3:directive | loglinear@3:directive | polynomial@3:directive > > = [ \\[@n { { < %f:min | \\*@n:minauto > } < :@n | to@n > { < %f:max | \\*@n:maxauto > } } \\]@n ]:@range_list %v:fit_function \\()@2 < %q:filename | %Q:filename | %S:filename > ( every@1 [ { %d:every_item } ]:every_list: ~ index@1 %f:index ~ select@1 %E:select_criterion ~ smooth@1 %f:smooth ~ using@1 { < rows@1:use_rows | columns@1:use_columns > } [ %E:using_item ]:using_list: )\n\
tabulate@2:directive = [ \\[@n { { < %f:min | \\*@n:minauto > } < :@n | to@n > { < %f:max | \\*@n:maxauto > } } \\]@n ]:@range_list ( [ < %q:filename | [ %e:expression ]:expression_list: > ( every@1 [ { %d:every_item } ]:every_list: ~ index@1 %f:index ~ select@1 %E:select_criterion ~ using@1 { < rows@1:use_rows | columns@1:use_columns > } [ %E:using_item ]:using_list: ) ]:@tabulate_list, ~ with@1 ( format@1 < %q:format | %Q:format > ) )\n\
...
unset@3:directive { item@1 %d:editno } numerics@2:set_option =\n\
