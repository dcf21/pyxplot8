...
set@3:directive                      filter@2:set_option = < %q:filename | %Q:filename | %S:filename > < %q:filter | %Q:filter | %S:filter >\n\
...
unset@3:directive                      filter@2:set_option = < %q:filename | %Q:filename | %S:filename >\n\
