...
set@2:directive { item@1 %d:editno } arrow@1:set_option = %d:arrow_id { from@1 } { < first@1:x1_system | second@1:x1_system | page@2:x1_system | graph@1:x1_system | axis@n %d:x1_system > } %fu:x1 ,@n { < first@1:y1_system | second@1:y1_system | page@2:y1_system | graph@1:y1_system | axis@n %d:y1_system > } %fu:y1 to@1 { < first@1:x2_system | second@1:x2_system | page@2:x2_system | graph@1:x2_system | axis@n %d:x2_system > } %fu:x2 ,@n { < first@1:y2_system | second@1:y2_system | page@2:y2_system | graph@1:y2_system | axis@n %d:y2_system > } %fu:y2 { with@1 ( < linetype@5 | lt@2 > %d:linetype ~ < linewidth@5 | lw@2 > %f:linewidth ~ style@2 %d:style_number ~ < colour@1 | color@1 > < rgb@n %d:colourR \\:@n %d:colourG \\:@n %d:colourB | %e:colour > ~ < nohead@2:arrow_style | head@2:arrow_style | twohead@2:arrow_style | twoway@2:arrow_style:twohead > ) }\n\
...
set@2:directive { item@1 %d:editno } label@2:set_option = %d:label_id < %q:label_text | %s:label_text > { at@1 } { < first@1:x_system | second@1:x_system | page@2:x_system | graph@1:x_system | axis@n %d:x_system > } %fu:x_position ,@n { < first@1:y_system | second@1:y_system | page@2:y_system | graph@1:y_system | axis@n %d:y_system > } %fu:y_position { rotate@1 %fu:rotation } { with@1 < colour@1 | color@1 > < rgb@n %d:colourR \\:@n %d:colourG \\:@n %d:colourB | %e:colour > }\n\
