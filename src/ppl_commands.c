...
image@2:directive = { item@1 %d:editno } = < %q:filename | %S:filename > ( at@2 %fu:x ,@n %fu:y ~ smooth@1:smooth ~ < notransparency@3:notrans | transparent@1 rgb@n %d:colourR \\:@n %d:colourG \\:@n %d:colourB > ~ rotate@1 %fu:rotation ~ < width@1 %fu:width | height@1 %fu:height > )\n\
