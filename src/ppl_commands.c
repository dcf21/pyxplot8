...
set@2:directive { item@1 %d:editno } logscale@1:set_option = { [ < %a:axis | t@n:tlog | c@n:clog > ]:axes } { %d:base }\n\
...
set@2:directive { item@1 %d:editno } nocolkey@4:set_option =\n\
...
set@2:directive { item@1 %d:editno } < nologscale@3:set_option | linearscale@3:set_option:nologscale > = { [ < %a:axis | t@n:tlog | c@n:clog > ]:axes }\n\
...
set@2:directive { item@1 %d:editno } samples@2:set_option = ( %d:samples ~ grid@2 < %d:samplesX | \\*@n:samplesXauto > { x@n } < %d:samplesY | \\*@n:samplesYauto > ~ interpolate@3 < inversesquare@1:method | nearestneighbour@1:method > )\n\
...
unset@3:directive { item@1 %d:editno } colkey@4:set_option =\n\
unset@3:directive { item@1 %d:editno } colmap@4:set_option =\n\
unset@3:directive { item@1 %d:editno } contour@3:set_option =\n\
unset@3:directive { item@1 %d:editno } crange@2:set_option =\n\
...
unset@3:directive { item@1 %d:editno } logscale@1:set_option = { [ < %a:axis | t@n:tlog | c@n:clog > ]:axes }\n\
...
unset@3:directive { item@1 %d:editno } nocolkey@4:set_option:colkey =\n\
...
unset@3:directive { item@1 %d:editno } nologscale@3:set_option:logscale = { [ < %a:axis | t@n:tlog | c@n:clog > ]:axes }\n\
