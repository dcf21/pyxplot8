...
set@2:directive { item@1 %d:editno } contour@3:set_option = < \\(@n [ %fu:contour ]:contour_list, \\)@n | %d:contours >\n\
set@2:directive { item@1 %d:editno } c@n < \\1@n:c_number | \\2@n:c_number | \\3@n:c_number | \\4@n:c_number > range@2:set_option:crange = ( reverse@1:reverse ~ \\[@n { < %fu:min | \\*@n:minauto > } < :@n | to@n > { < %fu:max | \\*@n:maxauto > } \\]@n ~ < renormalise@3:renormalise | renormalize@3:renormalise | norenormalise@3:norenormalise | norenormalize@3:norenormalise > )\n\
