...
set@2:directive { item@1 %d:editno } colmap@3:set_option = < rgb@n %E:colourR \\:@n %E:colourG \\:@n %E:colourB | hsb@n %E:colourH \\:@n %E:colourS \\:@n %E:colourB | cmyk@n %E:colourC \\:@n %E:colourM \\:@n %E:colourY \\:@n %E:colourK >\n\
...
unset@3:directive { item@1 %d:editno } colmap@3:set_option =\n\
