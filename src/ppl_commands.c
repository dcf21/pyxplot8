...
arc@3:directive = { item@1 %d:editno } { at@1 } %fu:x ,@n %fu:y radius@1 %fu:r from@1 %fu:angle1 to@1 %fu:angle2 { with@1 ( < linetype@5 | lt@2 > %d:linetype ~ < linewidth@5 | lw@2 > %f:linewidth ~ style@2 %d:style_number ~ < colour@1 | color@1 > < rgb@n %fi:colourR \\:@n %fi:colourG \\:@n %fi:colourB | %e:colour > ~ < fillcolour@1 | fillcolor@1 > < rgb@n %fi:fillcolourR \\:@n %fi:fillcolourG \\:@n %fi:fillcolourB | %e:fillcolour > ) }\n\
< line@2:directive | arrow@2:directive > = { item@1 %d:editno } { from@1 } %fu:x1 ,@n %fu:y1 to@1 %fu:x2 ,@n %fu:y2 { with@1 ( < linetype@5 | lt@2 > %d:linetype ~ < linewidth@5 | lw@2 > %f:linewidth ~ style@2 %d:style_number ~ < colour@1 | color@1 > < rgb@n %fi:colourR \\:@n %fi:colourG \\:@n %fi:colourB | %e:colour > ~ < nohead@2:arrow_style | head@2:arrow_style | twohead@2:arrow_style:twoway | twoway@2:arrow_style > ) }\n\
...
piechart@2:directive = { item@1 %d:editno } < %q:filename | [ %e:expression ]:expression_list: > ( every@1 [ { %d:every_item } ]:every_list: ~ index@1 %d:index ~ label@1 { < auto@1:piekeypos | inside@1:piekeypos | key@1:piekeypos | outside@1:piekeypos > } { %Q:label } ~ select@1 %E:select_criterion  ~ using@1 { < rows@1:use_rows | columns@1:use_columns > } [ { %E:using_item } ]:using_list: ~ with@1 ( < linetype@5 | lt@2 > < %d:linetype | %E:linetype_string > ~ < linewidth@5 | lw@2 > < %f:linewidth | %E:linewidth_string > ~ style@2 %d:style_number ~ < colour@1 | color@1 > < rgb@n %fi:colourR \\:@n %fi:colourG \\:@n %fi:colourB | rgb@n %E:colourRexpr \\:@n %E:colourGexpr \\:@n %E:colourBexpr | %e:colour > ) ~ format@1 < auto@1:auto_format | %Q:format_string > )\n\
< plot@1:directive = { item@1 %d:editno } | replot@3:directive = { item@1 %d:editno } > [ \\[@n { { < %fu:min | \\*@n:minauto > } < :@n | to@n > { < %fu:max | \\*@n:maxauto > } } \\]@n ]:@range_list [ < %q:filename | { parametric@1:parametric { \\[@n %fu:tmin < :@n | to@n > %fu:tmax \\]@n } } [ %e:expression ]:expression_list: > ( axes@1 %a:axis_1 %a:axis_2 { %a:axis_3 } ~ every@1 [ { %d:every_item } ]:every_list: ~ index@1 %d:index ~ label@1 %Q:label ~ select@1 %E:select_criterion { < continuous@1:continuous | discontinuous@1:discontinuous > } ~ < title@1 %q:title | notitle@3:notitle > ~ using@1 { < rows@1:use_rows | columns@1:use_columns > } [ { %E:using_item } ]:using_list: ~ with@1 ( < linetype@5 | lt@2 > < %d:linetype | %E:linetype_string > ~ < linewidth@5 | lw@2 > < %f:linewidth | %E:linewidth_string > ~ < pointsize@7 | ps@2 > < %f:pointsize | %E:pointsize_string > ~ < pointtype@6 | pt@2 > < %d:pointtype | %E:pointtype_string > ~ style@2 %d:style_number ~ < pointlinewidth@6 | plw@3 > < %f:pointlinewidth | %E:pointlinewidth_string > ~ < colour@1 | color@1 > < rgb@n %fi:colourR \\:@n %fi:colourG \\:@n %fi:colourB | rgb@n %E:colourRexpr \\:@n %E:colourGexpr \\:@n %E:colourBexpr | %e:colour > ~ < fillcolour@2 | fillcolor@2 | fc@2 > < rgb@n %fi:fillcolourR \\:@n %fi:fillcolourG \\:@n %fi:fillcolourB | rgb@n %E:fillcolourRexpr \\:@n %E:fillcolourGexpr \\:@n %E:fillcolourBexpr | %e:fillcolour > ~ < lines@1:style | points@1:style | lp@2:style:linespoints | linespoints@5:style | pl@2:style:linespoints | pointslines@5:style:linespoints | errorbars@6:style:yerrorbars | xerrorbars@1:style | yerrorbars@1:style | zerrorbars@1:style | xyerrorbars@3:style | xzerrorbars@3:style | yzerrorbars@3:style | xyzerrorbars@3:style | errorrange@6:style:yerrorrange | xerrorrange@1:style | yerrorrange@1:style | zerrorrange@1:style | xyerrorrange@3:style | xzerrorrange@3:style | yzerrorrange@3:style | xyzerrorrange@3:style | filledregion@3:style | yerrorshaded@8:style | upperlimits@1:style | lowerlimits@2:style | dots@1:style | impulses@1:style | boxes@1:style | wboxes@1:style | steps@1:style | fsteps@1:style | histeps@1:style | stars@3:style | arrows@3:style:arrows_head | arrows_head@3:style | arrows_nohead@3:style | arrows_twoway@3:style:arrows_twohead | arrows_twohead@3:style > ) ) ]:@plot_list,\n\
point@2:directive = { item@1 %d:editno } { at@2 } %fu:x ,@n %fu:y { label@1 < %q:label | %s:label > } { with@1 ( < pointsize@7 | ps@2 > < %f:pointsize | %E:pointsize_string > ~ < pointtype@6 | pt@2 > < %d:pointtype | %E:pointtype_string > ~ style@2 %d:style_number ~ < pointlinewidth@6 | plw@3 > < %f:pointlinewidth | %E:pointlinewidth_string > ~ < colour@1 | color@1 > < rgb@n %fi:colourR \\:@n %fi:colourG \\:@n %fi:colourB | rgb@n %E:colourRexpr \\:@n %E:colourGexpr \\:@n %E:colourBexpr | %e:colour > ~  ) }\n\
...
set@2:directive { item@1 %d:editno } < axescolour@5:set_option | axescolor@5:set_option:axescolour > = < rgb@n %fi:colourR \\:@n %fi:colourG \\:@n %fi:colourB | %e:colour >\n\
...
set@2:directive < { item@1 %d:editno } < data@1:dataset_type style@1:set_option | style@2:set_option data@1:dataset_type | function@1:dataset_type style@1:set_option | style@2:set_option function@1:dataset_type > | style@2:set_option:style_numbered %d:style_set_number > = ( < linetype@5 | lt@2 > %d:linetype ~ < linewidth@5 | lw@2 > %f:linewidth ~ < pointsize@7 | ps@2 > %f:pointsize ~ < pointtype@6 | pt@2 > %d:pointtype ~ style@2 %d:style_number ~ < pointlinewidth@6 | plw@3 > %f:pointlinewidth ~ < colour@1 | color@1 > < rgb@n %fi:colourR \\:@n %fi:colourG \\:@n %fi:colourB | %e:colour > ~ < fillcolour@2 | fillcolor@2 | fc@2 > < rgb@n %fi:fillcolourR \\:@n %fi:fillcolourG \\:@n %fi:fillcolourB | %e:fillcolour > ~ < lines@1:style | points@1:style | lp@2:style:linespoints | linespoints@5:style | pl@2:style:linespoints | pointslines@5:style:linespoints | errorbars@6:style:yerrorbars | xerrorbars@1:style | yerrorbars@1:style | zerrorbars@1:style | xyerrorbars@3:style | xzerrorbars@3:style | yzerrorbars@3:style | xyzerrorbars@3:style | errorrange@6:style:yerrorrange | xerrorrange@1:style | yerrorrange@1:style | zerrorrange@1:style | xyerrorrange@3:style | xzerrorrange@3:style | yzerrorrange@3:style | xyzerrorrange@3:style | filledregion@3:style | yerrorshaded@8:style | upperlimits@1:style | lowerlimits@2:style | dots@1:style | impulses@1:style | boxes@1:style | wboxes@1:style | steps@1:style | fsteps@1:style | histeps@1:style | arrows@3:style:arrows_head | arrows_head@3:style | arrows_nohead@3:style | arrows_twoway@3:style | arrows_twohead@3:style > )\n\
...
set@2:directive { item@1 %d:editno } < gridmajcolour@6:set_option | gridmajcolor@6:set_option:gridmajcolour > = < rgb@n %fi:colourR \\:@n %fi:colourG \\:@n %fi:colourB | %e:colour >\n\
set@2:directive { item@1 %d:editno } < gridmincolour@6:set_option | gridmincolor@6:set_option:gridmincolour > = < rgb@n %fi:colourR \\:@n %fi:colourG \\:@n %fi:colourB | %e:colour >\n\
...
set@2:directive { item@1 %d:editno } palette@1:set_option = [ < %q:colour | rgb@n %fi:colourR \\:@n %fi:colourG \\:@n %fi:colourB | %e:colour > ]:palette,\n\
...
set@2:directive { item@1 %d:editno } < textcolour@5:set_option | textcolor@5:set_option:textcolour > = < rgb@n %fi:colourR \\:@n %fi:colourG \\:@n %fi:colourB | %e:colour >\n\
...
tabulate@2:directive = [ \\[@n { { < %fu:min | \\*@n:minauto > } < :@n | to@n > { < %fu:max | \\*@n:maxauto > } } \\]@n ]:@range_list [ < %q:filename | { parametric@1:parametric { \\[@n %fu:tmin < :@n | to@n > %fu:tmax \\]@n } } [ %e:expression ]:expression_list: > ( every@1 [ { %d:every_item } ]:every_list: ~ index@1 %d:index ~ select@1 %E:select_criterion ~ using@1 { < rows@1:use_rows | columns@1:use_columns > } [ { %E:using_item } ]:using_list: ) { with@1 ( format@1 %q:format ~ spacing@1 %fu:spacing ) } ]:@tabulate_list,\n\
