...
set@2:directive { item@1 %d:editno } < colkey@4:set_option | colourkey@7:set_option:colkey | colorkey@6:set_option:colkey > = { < left@1:pos | right@1:pos | top@1:pos | bottom@2:pos > }\n\
set@2:directive { item@1 %d:editno } < colmap@4:set_option | colourmap@7:set_option:colmap | colormap@6:set_option:colmap > = < rgb@n %E:colourR \\:@n %E:colourG \\:@n %E:colourB | hsb@n %E:colourH \\:@n %E:colourS \\:@n %E:colourB | cmyk@n %E:colourC \\:@n %E:colourM \\:@n %E:colourY \\:@n %E:colourK >\n\
