...
foreach@4:directive = < %v:var_name in@n:in < \\(@n [ < %fi:value | %q:string | %S:string > ]:item_list, \\)@n | [ < %q:filename | %s:filename > ]:filename_list > { loopname@1 %s:loopname } ( \\{@n:brace ( %r:command ) )\n\
