...
set@2:directive { item@1 %d:editno } axescolor@5:set_option:axescolour = < rgb@n %d:colourR \\:@n %d:colourG \\:@n %d:colourB | %e:colour >\n\
set@2:directive { item@1 %d:editno } axescolour@5:set_option = < rgb@n %d:colourR \\:@n %d:colourG \\:@n %d:colourB | %e:colour >\n\
...
set@2:directive { item@1 %d:editno } gridmajcolor@6:set_option:gridmajcolour = < rgb@n %d:colourR \\:@n %d:colourG \\:@n %d:colourB | %e:colour >\n\
set@2:directive { item@1 %d:editno } gridmajcolour@6:set_option = < rgb@n %d:colourR \\:@n %d:colourG \\:@n %d:colourB | %e:colour >\n\
set@2:directive { item@1 %d:editno } gridmincolor@6:set_option:gridmincolour = < rgb@n %d:colourR \\:@n %d:colourG \\:@n %d:colourB | %e:colour >\n\
set@2:directive { item@1 %d:editno } gridmincolour@6:set_option = < rgb@n %d:colourR \\:@n %d:colourG \\:@n %d:colourB | %e:colour >\n\
...
set@2:directive { item@1 %d:editno } textcolor@5:set_option:textcolour = < rgb@n %d:colourR \\:@n %d:colourG \\:@n %d:colourB | %e:colour > \n\
set@2:directive { item@1 %d:editno } textcolour@5:set_option = < rgb@n %d:colourR \\:@n %d:colourG \\:@n %d:colourB | %e:colour > \n\
