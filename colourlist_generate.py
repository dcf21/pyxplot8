...
output.write("\n")
output.write("extern const char *SW_COLOUR_STR[];\n")
output.write("extern const int   SW_COLOUR_DCL[];\n")
output.write("extern const int   SW_COLOUR_INT[];\n\n")
output.write("#endif\n")
output.close()
